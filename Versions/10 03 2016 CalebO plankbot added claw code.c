...
task manipulator() {
	...
	// look here for claw code

	if(vexRT[Btn7L])
	{
		motor[clawS] = motor[clawS] + 1;
		motor[clawS2] = motor[clawS2] + 1;
	}
	...
	// claw code stops here


	/*	motor[clawS2] = motor[clawS2]
	if(vexRT[Btn7L]) { //(clawS = clawServo) this is servo code
	motor[clawS] = +1; //open the claw
	motor[clawS2] = +1;//open the claw
	}
	if(vexRT[Btn7R]) { //(clawS2 = clawServo2) this is servo code
	motor[clawS] = -1;//close clawS2
	motor[clawS2] = -1;//close clawS2
	}*/
